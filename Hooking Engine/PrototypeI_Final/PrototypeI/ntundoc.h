...
typedef struct _stPEB_LDR_DATA {
	ULONG					Length;
	BOOL					Initialized;
	PVOID					SsHandle;
	LIST_ENTRY				InLoadOrderModuleList;
	LIST_ENTRY				InMemoryOrderModuleList;
	LIST_ENTRY				InInitializationOrderModuleList;
} stPEB_LDR_DATA, *stPPEB_LDR_DATA;
...
typedef struct _stPROCESS_BASIC_INFORMATION {
    PVOID Reserved1;
    stPPEB PebBaseAddress;
    PVOID Reserved2[2];
    ULONG_PTR UniqueProcessId;
    PVOID Reserved3;
} stPROCESS_BASIC_INFORMATION;
