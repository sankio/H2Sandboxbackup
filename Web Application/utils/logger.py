def clean_log():
    sour = open('/home/zozanh/prethesis/process.xml', 'w')
    s = '<process>'
    #sour.write(s)
    sour.close()

    sour = open('/home/zozanh/prethesis/file.xml', 'w')
    s = '<functions>'
    sour.write(s)
    sour.close()

    sour = open('/home/zozanh/prethesis/reg.xml', 'w')
    s = '<registry>'
    sour.write(s)
    sour.close()

    sour = open('/home/zozanh/prethesis/network.xml', 'w')
    s = '<network>'
    sour.write(s)
    sour.close()
